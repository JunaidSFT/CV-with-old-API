                ...
                <div className = "row" style = {{margin: '100px 30px 30px 30px'}}>
                    ...
                    <Card className="border-1">
                         ...
                         <div className = "row" style = {{marginTop: '20px', marginLeft: '8px'}}>
                                    ...
                                    <img style = {{width:'100%', maxHeight:'70px', marginTop: '5px', objectFit: 'cover'}}
                                    ...
                                    <div className = "text-center" style = {{width: '150px', height: '100px', backgroundColor: '#69C86D', padding: '5px', marginTop: '10px'}}>
